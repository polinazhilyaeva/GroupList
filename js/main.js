...
var fullForm = ['name', 'lastName', 'gender', 'age', 'skype'],
    ...
    listContainerID = 'content',
    detailsContainerID = 'details',
    students = new StudentList(),
    listView = new ListView();

document.addEventListener('DOMContentLoaded', function () {
    listView.showList(listContainerID, fullForm, shortForm);
}, false);

studentListInit(students);
listView.setList(students);

// Delete or comment this line to disable "details" functionality
listView.enableDetails(fullForm, listContainerID, detailsContainerID);
